  ...
  <div class="container">
    <div class="row">
      <div class="col-6 bg-light">
        ...
        <hr />
        <form @submit.prevent="enviar($event)" @reset.prevent="resetar" action="">
          <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            ...
            <div class="col">
              <input
                ...
                class="form-control"
                multiple
                @change="selecionarAquivos($event)"
              />
            </div>
          </div>
          <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            ...
            <div class="col">
            <!-- <input-estralas :numero-estrelas="5" @avaliar="form.avaliacao = $event"/> -->
            <input-estralas :numero-estrelas="5" v-model:avaliar="form.avaliacao"/>
            </div>
          </div>
          <hr />
          <div class="mb-3 row">
      ...
      >
        ...
        <div class="mb-3 row">
          <span>Descrição:</span>
          <!-- <pre>{{ form.descricacao }}</pre> -->
          <div style="white-space: pre">{{ form.descricacao }}</div>
        </div>
        <div class="mb-3 row">
...
<script>
import InputEstralas from '@/components/InputEstralas.vue';
...
export default {
  ...
  data: () => ({
    cursos: [
      ...
      { id: 3, curso: "Desenvolvimento Web Avando com Laravel" },
